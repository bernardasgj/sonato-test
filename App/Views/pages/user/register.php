...
<html>
	<head>
		<title>Poker-2000 Registracija</title>
				...
				<form method="post" action="register" novalidate>
					<div class="input-group">
						<div class="input-field">
							...
							<input type="text" name="username" value="<?php echo isset($inputData['username']) ? $inputData['username'] : ''; ?>">
						</div>
					...
					<div class="input-group">
						<button type="submit" class="btn submit" name="reg_user">Saugoti <i class="fa fa-angle-right"></i></button>
					</div>
				</form>
			</div>
		</div>
